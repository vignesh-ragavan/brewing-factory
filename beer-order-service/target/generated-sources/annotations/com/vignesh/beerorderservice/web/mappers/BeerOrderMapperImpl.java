...
import com.vignesh.beerorderservice.domain.BeerOrder.BeerOrderBuilder;
import com.vignesh.beerorderservice.domain.BeerOrderLine;
import com.vignesh.beerorderservice.web.model.BeerOrderDto;
import com.vignesh.beerorderservice.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import com.vignesh.beerorderservice.web.model.BeerOrderLineDto;
import com.vignesh.beerorderservice.web.model.OrderStatusEnum;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum(com.vignesh.beerorderservice.domain.OrderStatusEnum orderStatusEnum) {
    ...
    protected com.vignesh.beerorderservice.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        com.vignesh.beerorderservice.domain.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = com.vignesh.beerorderservice.domain.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = com.vignesh.beerorderservice.domain.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = com.vignesh.beerorderservice.domain.OrderStatusEnum.PICKED_UP;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + orderStatusEnum );
        }
